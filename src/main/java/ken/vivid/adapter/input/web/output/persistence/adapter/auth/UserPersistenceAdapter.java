...
import ken.vivid.adapter.input.web.output.persistence.jpaEntities.auth.UserJpaEntity;
import ken.vivid.adapter.input.web.output.persistence.jpaRepositories.auth.UserJpaRepository;
